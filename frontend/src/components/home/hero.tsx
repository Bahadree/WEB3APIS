...
export default function Hero() {
  ...
  const t: Record<LangKey, {
    ...
    tr: {
      ...
      subtitle: 'Oyunlarınıza blokzincir gücü katın. Oyuncu kimlik doğrulama, NFT pazar yeri ve oyun içi ekonomi yönetimini kapsamlı Web3 API’lerimizle kolayca yönetin.',
      start: 'Hemen Başla',
      ...
      feature2desc: 'Unity, Unreal Engine ve özel oyunlar için kolay API’ler',
